...
import { feetchTweets } from '../utils/fetchTweets';
...
function TweetBox({ setTweets }: Props) {
    ...
    const postTweet = async () => {
        ...
        const newTweets = await feetchTweets();
        setTweets(newTweets);
    ...
    return (
        <div className="flex space-x-2 p-5">
            <img
                className="mt-4 h-14 w-14 rounded-full object-cover" src={session?.user?.image || "https://links.papareact.com/gll"} alt="" />
